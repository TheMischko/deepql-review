...
from agents.deepq_l import traces
from agents.deepq_l.dql_config import DQLConfig
from agents.deepq_l.neural_net import get_criterion, NeuralNet, get_optimizer
from agents.deepq_l.plotting_tools import PlottingTools
from agents.deepq_l.replay_memory import ReplayMemory, Transition
...
class IDeepQLAgent(Agent):
    ...
    def update_trace(self, action_vals):
        return getattr(traces, self.eligibility_strategy)(self.learning_rate, action_vals, self.eligibility)
